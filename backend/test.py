...
with open(
    "C:\\Users\\carlo\\Documents\\ITU\\Enterprise Systems and Information Management\\backend\\output.txt",
    "a",
) as output_file:
    output_file.write(f"{file_name}, {format}, {periode}")


full_path = f"C:\\Users\\carlo\\Documents\\ITU\\Enterprise Systems and Information Management\\frontend\\server\\{file_name}".replace(
    "\\", "\\\\"
)


# reading datasets
dataset = pd.read_excel(full_path)
